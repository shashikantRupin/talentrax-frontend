// store/actions.js
import { FETCH_COLOR_FAILURE, FETCH_COLOR_SUCCESS, FETCH_PLANETS_FAILURE, FETCH_PLANETS_SUCCESS, FETCH_SHAPE_FAILURE, FETCH_SHAPE_SUCCESS, FETCH_SIZE_FAILURE, FETCH_SIZE_SUCCESS, SET_SEARCH_TEXT, UPDATE_FILTERS } from "./actionType";
